...
```{r Features, fig.width=14}

knitr::kable(skimr::skim(data))
...
knitr::kable(head(train_data_Binary, 10))
# |> rmarkdown::paged_table()
...
knitr::kable(head(train_data_selected_Binary, 10))
# |> rmarkdown::paged_table()
```
...
knitr::kable(head(test_data_Binary, 10))
# |> rmarkdown::paged_table()
```
...
knitr::kable(head(test_data_selected_Binary, 10))
# |> rmarkdown::paged_table()
```
